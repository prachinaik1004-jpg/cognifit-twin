  ...
  return (
    <aside className="w-[260px] min-h-screen bg-white border-r border-gray-200 flex flex-col">
      <div className="px-5 pt-6 pb-4">
        <h1 className="text-base font-semibold text-text-main tracking-tight">
          Cognitive Health Twin
        </h1>
        <p className="text-xs text-text-muted mt-0.5">Your digital health mirror</p>
      </div>
      ...
      {showSimHistory && (
        <div className="border-t border-gray-100">
          <div className="px-5 py-3">
            <div className="flex items-center gap-2 text-xs font-semibold text-text-main mb-2">
            ...
            <div className="space-y-1">
              {pastSimulations.map((sim) => (
                ...
                >
                  <p className="text-xs text-text-main font-medium group-hover:text-primary transition-colors">
                    {sim.title}
                  </p>
                  <div className="flex items-center justify-between mt-1">
                    <span className="text-[11px] text-text-muted">{sim.date}</span>
      ...
      <div className="px-5 py-4 border-t border-gray-100">
        <p className="text-[11px] text-text-muted">v0.1.0 — Prototype</p>
      </div>
    </aside>
  );
}
